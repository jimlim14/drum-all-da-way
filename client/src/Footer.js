		...
		<section id='footer'>
			<div className='footer-div-1'>
				...
				<div className='footer-text-div'>
					...
					<p className='footer-p'>
						...
						perseverance, and the help of our professional instructors expertise
						in helping you to begin your journey.
					</p>
				</div>
				<Link to='/beginner-instructors'>
			...
			<div className='footer-div-2'>
				...
				<div className='footer-text-div'>
					...
					<p className='footer-p'>
						Ever feel like you haven't made progress for some time by playing as
						an Amateur? Do not be afraid, book one of our instructors to get you
						back on your feet.
					</p>
				</div>
				<Link to='/amateur-instructors'>
					<button className='footer-amateur-btn'>LEARN MORE</button>
				</Link>
			</div>
			<div className='footer-div-3'>
				<img className='footer-professional-img' src={professionalImg} alt='' />
				...
				<Link to='/professional-instructors'>
