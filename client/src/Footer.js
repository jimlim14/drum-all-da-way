...
export default function Footer() {
  ...
  function categories(category) {
    const categoryInstructor = instructors.map((instructor) => {
      if (instructor.category.includes(category)) {
        return instructor;
      }
    });
      ...
      <>
        <section id='footer'>
          <div className='footer-div-1'>
            ...
            <a
              href='https://www.youtube.com/watch?v=et9hU7QMDYU'
              target='_blank'
            >
          ...
          <div className='footer-div-2'>
            ...
            <div className='footer-text-div'>
              ...
              <p className='footer-p'>
                Ever feel like you haven't made progress for some time by
                playing as an Amateur? Do not be afraid, book one of our
                instructors to get you back on your feet.
              </p>
            </div>
            <a
              href='https://www.youtube.com/watch?v=IYu-cxLb1-o'
              target='_blank'
            >
          ...
          <div className='footer-div-3'>
            ...
            <div className='footer-text-div'>
              ...
              <p className='footer-p'>
                Do not stop even if you think you are good enough, throw
                whatever you have got to our professional instructors, exchange
                skills and knowledge, be even pro-er.
              </p>
            </div>
            <a
              href='https://www.youtube.com/watch?v=lQzJ5GKpn5I'
              target='_blank'
            >
